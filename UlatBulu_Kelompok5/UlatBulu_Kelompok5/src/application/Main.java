...
public class Main extends Application {
    ...
    private static final String BODY_IMAGE = new String("application/resources/Badan.png");
    private static final String WHITE_HEAD = new String("application/resources/Kepala Putih.png");
    private static final String RED_HEAD = new String("application/resources/Kepala Merah.png");
    private static final String YELLOW_HEAD = new String("application/resources/Kepala kuning.png");
    private static final String GREEN_HEAD = new String("application/resources/Kepala hijau.png");
    ...
    private Image KepalaUlat = new Image(YELLOW_HEAD);
    private Image BadanUlat = new Image(BODY_IMAGE);
    ...
    private void run(GraphicsContext gc) {
    	if (gameOver) {
    		DeadScene GOScene = new DeadScene();
    ...
    private void drawBackground(GraphicsContext gc) {
        for (int i = 0; i < ROWS; i++) {
            for (int j = 0; j < COLUMNS; j++) {
                if ((i + j) % 2 == 0) {
                    gc.setFill(Color.web("964800"));
                } else {
                    gc.setFill(Color.web("783C00"));
                }
